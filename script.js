var canvas=document.getElementById("canvas");canvas.width=window.innerWidth,canvas.height=window.innerHeight;var gl=canvas.getContext("webgl");gl||console.error("Unable to initialize WebGL.");var time=0,vertexSource=void main();gl_Position=vec4(position,0,1),`
var fragmentSource = 
